...
determine_request_type(const char *path)
{
    ...
    if (s.st_mode & S_IFDIR) { //or S_ISDIR(s.st_mode)
        type = REQUEST_BROWSE;
...
http_status_string(http_status status)
{
    ...
    switch(status){
      case 0: //HTTP_STATUS_OK
        status_string = "200 OK\n";
        break;
      case 1: //HTTP_STATUS_BAD_REQUEST
        status_string = "400 BAD REQUEST\n";
        break;
      case 2: //HTTP_STATUS_NOT_FOUND
        status_string = "404 NOT FOUND\n";
        break;
      case 3: //HTTP_STATUS_INTERNAL_SERVER_ERROR
